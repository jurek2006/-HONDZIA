...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'bg-white dh-post' .  $sticky_helper ); ?>>
	...
	<div class="post-content">
		...
		<div class="post-body-content">
			...
			else: the_content( __( 'Czytaj dalej', 'sentio' ) ); endif; //ZMIENIONE?> 
		</div>
		<?php
			wp_link_pages( array(
		...
		<div class="row">
			<div class="col-sm-6">
				<?php if( !empty( $prev_post ) ): ?>
					...
					<span><?php  _e('Poprzedni wpis', 'sentio'); //ZMIENIONE ?></span>
			...
			<div class="col-sm-6">
				<?php if( !empty( $next_post ) ): ?>
					<div class="post-next bg-white">
						...
						<span><?php  _e('Następny wpis', 'sentio'); //ZMIENIONE ?></span>
